...
var centerMenu = [
    ...
    ,{
        name: '自习室收藏',
        url: '../zixishiCollection/list.html'
    }
    ,{
        name: '自习室留言',
        url: '../zixishiLiuyan/list.html'
    }
    ,{
        name: '订座预约',
        url: '../zixishiOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/zxsguanliyuyue/admin/dist/index.html#/login";
